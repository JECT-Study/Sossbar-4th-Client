const CardSkeleton = () => (
  <div className="border-border-gray bg-surface-white flex justify-between rounded-[16px] border p-8">
...
export const MypageSkeleton = () => (
  <div
    className="mx-auto flex w-full max-w-[1200px] flex-col gap-[30px]"
    role="status"
    aria-label="마이페이지 정보를 불러오는 중"
    aria-busy="true"
  >
    <div className="border-border-gray-light flex flex-col gap-2 border-b-[3px] pt-[62px] pb-8">
