  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <DialogAnimatedPortal
        ...
        className="border-border-gray-light bg-surface-white fixed top-1/2 left-1/2 z-50 flex w-[min(360px,calc(100vw-32px))] flex-col items-center overflow-hidden rounded-2xl border p-6 shadow-xl"
      >
