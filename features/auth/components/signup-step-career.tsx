      ...
      <div className="mt-10 flex flex-col gap-2">
        ...
        {linkRows.length < USER_LINKS_MAX ? (
          <button
            ...
            className="text-detail-sm text-text-subtle hover:bg-button-tertiary-fill-hover active:border-border-gray-light flex w-fit flex-row items-center rounded-md border border-transparent pr-1.5 pl-px font-medium"
          >
