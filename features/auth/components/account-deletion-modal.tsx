    ...
    <>
      <Dialog.Root open={open} onOpenChange={onOpenChange}>
        <DialogAnimatedPortal
          ...
          className="border-border-gray bg-surface-white fixed top-1/2 left-1/2 z-50 flex h-[min(680px,calc(100vh-48px))] w-[min(592px,calc(100vw-32px))] flex-col overflow-hidden rounded-2xl border p-10 shadow-xl"
        >
          <form onSubmit={handleFormSubmit} className="flex min-h-0 flex-1 flex-col gap-6">
            ...
            <div className="flex shrink-0 justify-end gap-2">
              ...
              <Button type="submit" variant="primary" size="medium" className="h-11 min-w-[68px]" disabled={!canSubmit}>
                제출하기
              </Button>
            </div>
          </form>
