...
import { DISTRIBUTION_BAR_STACK_HEIGHT_PX, scaleBarHeight, toDistributionBars } from '../spectrum.lib';
...
export const SpectrumDistributionSection = ({ spectrumInfo }: Props) => {
  ...
  return (
    <div className="mt-6 w-full">
      ...
      <div className="flex w-full items-start justify-center gap-2 lg:h-[242px]">
        {bars.map((bar, index) => {
          ...
          return (
            <div key={bar.label} className="flex min-w-0 flex-1 flex-col items-center lg:w-[58.625px] lg:flex-none">
              <div
                ...
                style={{ height: DISTRIBUTION_BAR_STACK_HEIGHT_PX }}
              >
