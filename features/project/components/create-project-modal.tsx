  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <DialogAnimatedPortal
        ...
        className={cn(
          'border-border-gray bg-surface-white fixed top-1/2 left-1/2 z-50 flex max-h-[calc(100vh-24px)] w-[min(600px,calc(100vw-16px))] flex-col overflow-hidden rounded-lg border px-11 py-10 shadow-xl',
          className,
        )}
      >
